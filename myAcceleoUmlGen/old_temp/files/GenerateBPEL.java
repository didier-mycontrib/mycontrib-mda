...
/**
 * Entry point of the 'GenerateBPEL' generation module.
 *
 * @generated
 */
public class GenerateBPEL extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/m2t/uml/gen/soa/files/generateBPEL";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateBPELFile" };
  ...
  /**
	 ...
	 * @generated
	 */
	public GenerateBPEL(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateBPEL(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateBPEL generator = new GenerateBPEL(modelURI, folder, arguments);
